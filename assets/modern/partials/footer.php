...
<footer class="rh_footer <?php echo esc_attr($border_class); ?>">
	...
	<div class="rh_footer__wrap rh_footer--space_between">
		<p class="copyrights">
			...
			$copyrights = "<a href='https://pidhomes.ca' > $copyrights </a>";
		...
		<p class="copyrights">
			<a href="sitemap.xml" target="#">Sitemap PIDHomes.ca</a>
		</p>
		<!-- /.sitemap -->
		...
		<p class="copyrights" id="pid_language_cn">
			<a href="https://cn.pidhomes.ca" target="_blank">Chinese</a>
		</p>
		<p class="copyrights" id="pid_language_en">
			<a href="https://pidhomes.ca" target="_blank">English</a>
		</p>
	</div>
	<!-- /.rh_footer__wrap -->
