                    ...
                    ?>
                        <ul class="slides">
                            ...
                            ?>
                                    <li>
                                        <?php
                                        /** *@since [.200907] @var ADD_MOBILE_DETECTION */
                                        $x_position = is_mobile() ? '30%' : '50%';
                                        $mobile_image = get_field('mobile_image');
                                        if ($mobile_image) {
                                            $mobile_image_url = $mobile_image['url'];
                                        }
                                        $slider_image_url = is_mobile() ? $mobile_image_url : $slider_image_url;
                                        ?>
                                        <?php if (!empty($slide_url)) : ?>
                                            <a class="slide" href="<?php echo (!empty($slide_url)) ? esc_url($slide_url) : '#'; ?>" style="background: url('<?php echo esc_url($slider_image_url); ?>') <?php echo $x_position; ?> 50% no-repeat; background-size: cover;">
                                            </a>
                                        <?php else : ?>
                                            <div class="slide" style="background: url('<?php echo esc_url($slider_image_url); ?>') <?php echo $x_position; ?> 50% no-repeat; background-size: cover;">
                                            </div>
                                        <?php endif; ?>
                            ...
                            while ($slider_query->have_posts()) :
                                ...
                                if ($slider_image_id) {
                                    ...
                                    <li>
                                        ...
                                        <a class="slide" href="<?php the_permalink(); ?>" style="background: url('<?php echo esc_url($slider_image_url); ?>') 50% 50% no-repeat;
