...
/**
 * @version [.200830] OVERRIDE WP_QUERY CLASS TEMPERATELY
 * @var OVERRIDE:: ignore error reporting from  line#1801 BY ADDING SIGN '@'
 * @var ORIGINAL:: @do_action_ref_array('pre_get_posts', array(&$this));
 */
/**
