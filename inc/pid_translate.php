 ...
 * 
 * @version [.200831] START USING PoEdit TO ADD LANGUAGE PACKAGES
 */
...
// language translation function
if (!function_exists('pid_po_translate')) {
  function pid_po_translate($lang, $options)
  {

    if ($options === 2) {
      $lang_set = array(
        'all' => __('All Types&nbsp', 'pidhomes'),
        'townhouse' => __('Townhouse&nbsp', 'pidhomes'),
        'detached' => __('Single House&nbsp', 'pidhomes'),
        'condo' => __('Apartment&nbsp', 'pidhomes'),
        'groupbynbh' => __('By Hoods', 'pidhomes'),
        'select_property_type' => __('Property Type:&nbsp', 'pidhomes'),
        'select_year' => __('Years:&nbsp', 'pidhomes'),
        'select_month' => __('Start Month:&nbsp', 'pidhomes'),
        'select_chart' => __('Chart Type:&nbsp', 'pidhomes'),
        'chart_dollar' => __('HPI Price $ $&nbsp', 'pidhomes'),
        'chart_percentage' => __('HPI $ Change %&nbsp', 'pidhomes'),
        'section_more_charts' => __('More Community Market Charts:', 'pidhomes'),
      );
      return $lang_set;
    }
    // Search Chinese City Name or other language
    ...
    $dwelling_types = array(
      'detached' => __('detached', 'pidhomes'),
      'townhouse' => __('townhouse', 'pidhomes'),
      'apartment' => __('apartment', 'pidhomes'),
      'condo' => __('condo', 'pidhomes'),
      'all' => __('all', 'pidhomes'),
      'groupbynbh' => __('all', 'pidhomes'),
    );

    $dwelling_type = ucfirst($dwelling_types[$options['property_type']]);

    $lang_set = array(
      'locale' => $lang == 'cn' ? 'zh_CH' : 'en_US',
      'title' => "{$location} " . __("Housing Market Chart and Report", 'pidhomes') . " | Peter Qu | " . "{$location} " . __('REALTOR', 'pidhomes') . " | PIDHOMES.ca",
      'city' => "$location",
      'section_title' => "{$location} " . __("Real Estate", 'pidhomes') . "{$dwelling_type} " . __("HPI Home Price Chart", 'pidhomes'),
      'section_content' => __("[How to use]", 'pidhomes') . __("Select a Greater Vancouver City/District, the communities of the City will be displayed under the main panel.", 'pidhomes') .
        __(" Select one or more communities to show or compare the HPI House Price Trend Line. Press X to reset and start over.", 'pidhomes') .
        sprintf(__(" For Example, if you want to check the %s", 'pidhomes'), " $location") .
        sprintf(__(" Communities House Price Trend, first click %s", 'pidhomes'), " $location") .
        '<br><br>' .
        __(" Label, then you can select any community from the sub panel, and the Trend Line will be displayed according to your selection.", 'pidhomes') .
        __(" HPI stands for MLS® Home Price Index, which is published by <b>CREA</b>(The Canadian Real Estate Association) and Real Estate Boards of every area. HPI tracks trends in home prices in markets across Canada.", 'pidhomes'),
      'HPI_table_title' => "{$location} " . __("Real Estate Monthly House HPI", 'pidhomes'),
      'this_month_label' => '[' . date('F Y') . ']',
      'active_listings_label' => "{$location} " . __("Active Listings", 'pidhomes'),
      'section_more_charts' => __('More Community Market Charts', 'pidhomes')
    );
    return $lang_set;
  }
